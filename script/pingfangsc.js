...
const original = path.resolve(__filename, "../../public/fonts/original/PingFang/PingFangSC")
const division = path.resolve(__filename, "../../public/fonts/division/PingFangSC")
